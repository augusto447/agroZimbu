            ...
            <div className="max-w-7xl mx-auto px-10 py-16">
                <div className="flex gap-16 justify-between">
                    ...
                    <div className="flex-1">
                        <img src={logo} alt="AgroZimbu" className="w-24 h-24 object-contain mb-4" />
                ...
                {/* Linha separadora */}
                <div className="border-t border-green-700 mt-12 pt-6 flex items-center justify-between">
                    <p className="text-green-400 text-sm">© 2025 AgroZimbu. Todos os direitos reservados.</p>
                    <p className="text-green-400 text-sm">Feito com ❤️ em Angola</p>
                </div>
            </div>
        </footer>
    )
